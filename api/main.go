...
func main() {
	...
	router.GET("/crash/builds", endpoints.GetCrashBuilds)
	router.GET("/crash/settings", endpoints.GetCrashSettings)
	router.PUT("/crash/settings", endpoints.UpdateCrashSettings)
	...
	router.GET("/packrat/version", endpoints.GetPackratVersion)
	router.GET("/packrat/version/settings", endpoints.GetPackratVersionSettings)
	router.PUT("/packrat/version/settings", endpoints.UpdatePackratVersionSettings)
	...
	router.POST("/user/:id/block", endpoints.BlockUser)
